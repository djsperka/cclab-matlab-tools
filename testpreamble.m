...
ctext={ ...
    'text', {'First arg is written to the screen.\nSecond arg is a char string, so it is written to the console,\nand waits for you to hit a key on the keyboard.', 'welcome...', }; ...
    'text', {'First arg is written to the screen.\nSecond arg is a vec, so we wait for a button from the responder.', [0,1], }; ...   
    @(w,x) fprintf(x), {'hello\n'};... 
    'operator',{'Just ran the custom function.'};...
};
